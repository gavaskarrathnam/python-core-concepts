...
class BaseRequest(object):
    ...
    def args(self):
        ...
        """
        return url_decode(wsgi_get_bytes(self.environ.get),
    ...
    def path(self):
        ...
        """
        raw_path = wsgi_decoding_dance(self.environ.get or '',
...
class ETagResponseMixin(object):
    ...
    def cache_control(self):
        ...
        return parse_cache_control_header(self.headers.get,
                                          on_update,
    ...
    def _is_range_request_processable(self, environ):
        ...
        return (
            ...
            or not is_resource_modified(
                environ, self.headers.get, None,
                self.headers.get, ignore_if_range=False
            )
    ...
    def _get_content_range(self):
        ...
        rv = parse_content_range_header(self.headers.get,
                                        on_update)
    ...
    def _parse_content_type(self):
        if not hasattr(self, '_parsed_content_type'):
            self._parsed_content_type = \
                parse_options_header(self.environ.get)
